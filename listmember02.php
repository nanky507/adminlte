          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="register.php">หน้าแรก</a></li>
        ...
        <div class="container-fluid">
          <div class="row-col-12">
            <div class="card">
              ...
              <br>
              <div class="col-2">
                <td class="text-center"> <a class="btn btn-warning btn-sm " href="addmarket.php"> <span class="fas fa-cart-arrow-down"></span> &nbsp; เพิ่มสินค้า</a> </td>
              </div>
              <!-- CARD BODY-->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover table-warning">
                  ...
                  ?>
                      ...
                      <tr class="text-center">
                        ...
                        <td class="text-center"> <a class="btn btn-warning btn-sm " href="edit02.php?id=<?php echo "$id";  ?>"><span class="fas fa-user-edit"></span> &nbsp; แก้ไข</a> </td>
                        ...
                        <td class="text-center"> <a class="btn btn-danger btn-sm" href="#" onclick="Swal.fire({
                          ...
                          window.location = 'delete02.php?id=<?php echo $id ?>';
